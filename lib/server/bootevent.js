...
function boot (env, language) {
  ...
  function checkNodeVersion (ctx, next) {
    ...
    if (isLTS || (semver.satisfies(nodeVersion, '^24.0.0') || semver.satisfies(nodeVersion, '^22.0.0') || semver.satisfies(nodeVersion, '^20.0.0') || semver.satisfies(nodeVersion, '^18.0.0') || semver.satisfies(nodeVersion, '^16.0.0') || semver.satisfies(nodeVersion, '^14.0.0'))) {
      //Latest Node LTS versions (14, 16, 18, 20, 22, 24) are recommended and supported.
