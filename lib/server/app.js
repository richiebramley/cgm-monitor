...
function create (env, ctx) {
  ...
  var appPages = {
    ...
    , "/weeklysummary": {
      file: "weeklysummary.html"
      , title: 'Weekly Summary'
      , type: 'report'
    }
    , "/weeklysummary-enhanced": {
      file: "weeklysummary-enhanced.html"
      , title: 'Enhanced Weekly Summary'
      , type: 'report'
    }
    , "/split": {
      file: "frame.html"
  ...
  // Enhanced Weekly Summary API
  const weeklySummaryAPI = require('../api/weekly-summary/')(app, wares, ctx, env);
  app.use('/api/v1/weekly-summary', weeklySummaryAPI);
